    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                <img src="img/pusri.png" alt="Logo BPJS" class="logo-image mt-4" style="max-width: 100%;">
            </a>
            <li class="nav-item">
                <a class="nav-link text-center mt-3" href="index.php">
                    <span>Pendataan Magang PT Pusri</span>
                </a>
            </li>
            <!-- Divider -->
            ...
            <?php if (isset($_SESSION["admin"])) { ?>
                <!-- Kode yang ingin ditampilkan jika sesi admin ada -->
                <hr class="sidebar-divider">
                <li class="nav-item">
                    <a class="nav-link" href="angkatandaftar.php">
                        <i class="fas fa-fw fa-users"></i>
                        <span>Data Angkatan</span></a>
                </li>
                <hr class="sidebar-divider">
                <li class="nav-item">
                    <a class="nav-link" href="mahasiswadaftar.php">
                ...
                <hr class="sidebar-divider">
                <li class="nav-item">
                    <a class="nav-link" href="kelolaUser.php">
                        <i class="fas fa-fw fa-folder"></i>
