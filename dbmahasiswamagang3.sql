...
CREATE TABLE IF NOT EXISTS `angkatan` (
  ...
  `tahun` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mahasiswa` (
  ...
  `jenjang` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `jeniskelamin` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `foto_ktm` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `tanggalmasuk` date DEFAULT NULL,
  `tanggalkeluar` date DEFAULT NULL,
  `filelaporan` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
